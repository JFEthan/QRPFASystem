...
public:
  ...
  */
  ...
  QCPLineEnding(EndingStyle style, QString text,Qt::AlignmentFlag);
...
public:
  ...
  */
  ...
  // QCPScatterStyle(ScatterShape shape, const QPen &pen, const QBrush &brush, double sizeWith,double sizeHigh);
  // getters:
