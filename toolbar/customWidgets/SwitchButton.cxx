...
SwitchButton::SwitchButton(QWidget *parent) : QWidget(parent) {
  ...
  m_bgColorOn = QColor("#3866E6");
  m_bgColorOff = QColor("#686868");

  m_sliderColorOn = QColor("#FFDB94");
  m_sliderColorOff = QColor("#FFDB94");

  m_textColor = QColor("#F6F7FC");
...
void SwitchButton::drawBackGround(QPainter *painter) {
  ...
  int sliderWidth = 50 - m_space * 2 - 10;
  if (m_checked) {
...
void SwitchButton::setSpace(int space) {
 ...
 void SwitchButton::setHide(bool ish)
 {
  m_isHide = ish;
 }
